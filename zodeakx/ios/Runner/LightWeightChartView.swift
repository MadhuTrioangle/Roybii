...
//  Runner
//
//  Created by Trioangle technologies on 04/12/23.
//
...
class FLNativeView: NSObject, FlutterPlatformView {
    ...
    private var height = 2.0
    private var width = 3.0
    ...
    init(
        ...
        print(args)
        let viewDatas = args as! [String: Any]
        self.height = viewDatas["height"] as! Double
        self.width = viewDatas["width"] as! Double
    ...
    func createNativeView(view _view: UIView){
        let options = ChartOptions(
            ...
            kineticScroll: KineticScrollOptions(touch: true)
            //handleScroll: .enabled(true),
            //kineticScroll: KineticScrollOptions(touch: true)
        )
        let chart = LightweightCharts(options: options)
        chart.frame = CGRect(x: 0, y: 10, width: Double(self.width), height: Double(self.height) - 10)
        //_view.addSubview(chart)
        print()
        _view.addSubview(chart)
        self.chart = chart
        setupData()
    ...
    private func setupData() {
        let options = CandlestickSeriesOptions(
            ...
            upColor: "rgba(57, 172, 115, 0.8)",
            downColor: "rgba(255, 77, 77, 1)",
            //downColor: "#000",
            borderUpColor: "rgba(57, 172, 115, 0.8)",
            borderDownColor: "rgba(255, 77, 77, 1)",
            wickUpColor: "rgba(57, 172, 115, 0.8)",
            wickDownColor: "rgba(255, 77, 77, 1)"
        )
        let series = chart.addCandlestickSeries(options: options)
        let data = [
            CandlestickData(time: .string("2018-10-19"), open: 97, high: 180.99, low: 178.57, close: 179.85),
        ...
        let volumeSeriesOptions = HistogramSeriesOptions(
                ...
                let volumeData = [
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-10-19"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-10-22"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-10-23"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-10-24"), value: 97),
                    HistogramData(color: "rgba(255,82,82, 0.8)", time: .string("2018-10-25"), value: 97),
                    HistogramData(color: "rgba(255,82,82, 0.8)", time: .string("2018-10-26"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-10-29"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-10-30"), value: 97),
                    HistogramData(color: "rgba(255,82,82, 0.8)", time: .string("2018-10-31"), value: 97),
                    HistogramData(color: "rgba(255,82,82, 0.8)", time: .string("2018-11-01"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-02"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-05"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-06"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-07"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-08"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-09"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-12"), value: 97),
                    HistogramData(color: "rgba(255,82,82, 0.8)", time: .string("2018-11-13"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-14"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-15"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-16"), value: 97),
                    HistogramData(color: "rgba(0, 150, 136, 0.8)", time: .string("2018-11-19"), value: 97),
                    HistogramData(color: "rgba(255,82,82, 0.8)", time: .string("2018-11-20"), value: 97),
                    HistogramData(color: "rgba(255,82,82, 0.8)", time: .string("2018-11-21"), value: 97),
                    HistogramData(color: "rgba(255,82,82, 0.8)", time: .string("2018-11-23"), value: 97),
