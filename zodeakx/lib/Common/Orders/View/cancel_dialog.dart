                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomText(
                                      text: stringVariables.orderCancellationContent,
                                      align: TextAlign.center,
                                      fontfamily: 'GoogleSans',
                                      fontsize: 15,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        CustomElevatedButton(
                                            text: stringVariables.no.toUpperCase(),
                                            multiClick: true,
                                            color: black,
                                            press: () {
                                            ...
                                            icon: null),
                                        CustomElevatedButton(
                                            text: stringVariables.yes.toUpperCase(),
                                            multiClick: true,
                                            color: black,
                                            press: () {
                                              viewModel.cancelOrder(viewModel.openOrderHistory![index].id, context);
                                              Navigator.pop(context);
                                            },
                                            radius: 25,
