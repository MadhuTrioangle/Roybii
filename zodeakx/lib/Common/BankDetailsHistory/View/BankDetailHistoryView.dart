              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CustomText(
                      text: "Primary Account Confirmation",
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 0.0),
                    child: CustomText(
                      text: 'Primary Account is selected already.',
                      color: textGrey,
                      fontsize: 15,
                    ),
                  ),
          ...
          press: () {
            if (username.text.isNotEmpty &&
              ...
              customSnackBar.showSnakbar(
                  context, "Provide a valid data!", SnackbarType.negative);
            }
          },
          radius: 25,
          buttoncolor: themeColor,
