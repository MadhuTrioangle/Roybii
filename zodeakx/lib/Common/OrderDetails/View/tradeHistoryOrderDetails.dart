...
class TradeHistoryDetailsView extends StatefulWidget {
  ...
  TradeHistoryDetailsView({Key? key,this.orderName,this.tradeHistoryModelDetails}) : super(key: key);

  @override
  State<TradeHistoryDetailsView> createState() => _TradeHistoryDetailsViewState();
}
