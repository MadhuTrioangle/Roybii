...
class OrderDetailsView extends StatefulWidget {
  ...
  OrderDetailsView({Key? key,this.orderName,this.order,this.cancelOrder,this.tradeHistoryModelDetails}) : super(key: key);
...
class _OrderDetailsViewState extends State<OrderDetailsView> {
        ...
        child: CustomContainer(
          ...
          child: Column(
              children: [
                ...
                buildHeader(size) : widget.orderName == "cancelOrders" ? buildCancelHeader(size) : buildHistoryHeader(size),
                widget.orderName == "openOrders" ? buildDetailsCard(size) : widget.orderName == "cancelOrders" ? buildCancelDetailsCard(size)
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  CustomText(
                    color: widget.tradeHistoryModelDetails?.tradeType.toString().toLowerCase() ==
                        stringVariables.buy.toLowerCase()
                        ? green
                        : red,
                    text: widget.tradeHistoryModelDetails!.orderType.toString() + "/" + widget.tradeHistoryModelDetails!.tradeType.toString(),
                    softwrap: true,
                    overflow: TextOverflow.ellipsis,
                    fontsize: 15,
                    fontWeight: FontWeight.w700,
              ...
              Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      CustomText(
                        text: trimDecimals(widget.tradeHistoryModelDetails!.price.toString()),
                        softwrap: true,
                        overflow: TextOverflow.ellipsis,
                        fontsize: 15,
                        fontWeight: FontWeight.w700,
        ...
        children: [
            ...
            children: [
              ...
              Row(
                children: [
                  CustomText(
                    text: trimDecimals(
                        widget.tradeHistoryModelDetails!.adminFeeAmount.toString()),
                    softwrap: true,
                    overflow: TextOverflow.ellipsis,
                    fontsize: 15,
                    fontWeight: FontWeight.w700,
                  ...
                  CustomText(
                    text: (widget.tradeHistoryModelDetails!.tradeType.toString().toLowerCase() ==
                        stringVariables.buy.toLowerCase())
                        ? " $fromCurrency"
                        : " $toCurrency",
                    softwrap: true,
          ...
          Row(
            ...
            children: [
              ...
              Row(
                children: [
                  CustomText(
                    text: trimDecimals(widget.tradeHistoryModelDetails!.total.toString()),
                    softwrap: true,
                    overflow: TextOverflow.ellipsis,
                    fontsize: 15,
                    fontWeight: FontWeight.w700,
          ...
          Row(
            ...
            children: [
              ...
              CustomText(
                text: getDateFromTimeStamp(widget.tradeHistoryModelDetails!.createdDate.toString()),
                softwrap: true,
                overflow: TextOverflow.ellipsis,
                fontsize: 15,
                fontWeight: FontWeight.w700,
  ...
  Widget buildDetailsCard(Size size) {
    String filled =
    trimDecimals(widget.order?.status == stringVariables.filled.toLowerCase()
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              CustomText(
                text: getDateFromTimeStamp(
                    widget.order!.tradedDate.toString()),
                softwrap: true,
                overflow: TextOverflow.ellipsis,
                fontsize: 13,
                fontWeight: FontWeight.w700,
  ...
  Widget buildHeader(Size size) {
    ...
    double.parse(trimDecimals(
        ((widget.order?.status.toString() == stringVariables.filled.toLowerCase()
