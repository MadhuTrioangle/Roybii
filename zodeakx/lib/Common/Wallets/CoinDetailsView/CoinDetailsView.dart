...
class _CoinDetailsViewState extends State<CoinDetailsView> {
  ...
  void initState() {
    ...
    securedPrint("widget.currencyName${widget.currencyName}");
                    ...
                    child: Row(
                      ...
                      children: [
                        CustomText(
                          ...
                          text: dropdownvalue ?? "${widget.currencyCode}",
                          color: textGrey,
                        ),
                        CustomContainer(
                          width: 25,
            ...
            child: Row(
              ...
              children: [
                ...
                CustomElevatedButton(
                    ...
                    color: black,
                    press: () {
                      moveToCommonWithdrawView(context, widget.currencyType,
                          ' ${constant.walletCurrency.value}',viewmodel.inOrderBalance?.availableBalance.toString());
                    },
                    width: 2.6,
                    isBorderedButton: true,
                    maxLines: 1,
                          ...
                          return GestureDetector(
                            onTap: () {
                              moveToTransactionDetailView(
                                context,
                                '${filteredCryptoTransaction?[index].amount_mob}',
                                ...
                                '${filteredCryptoTransaction?[index].userAmount}',
