...
class StakingProductModal extends ModalRoute {
  late BuildContext context;
  late StakingTransactionViewModel viewModel;

  StakingProductModal(BuildContext context) {
    viewModel =
  ...
  reset() {
    viewModel.setBeforeProduct(viewModel.selectedProduct);
  }
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    CustomText(
                                        text: stringVariables.selectProduct,
  ...
  Widget buildFilterItem(String title, int set) {
    String value = viewModel.beforeProduct;
    return GestureDetector(
      onTap: () {
        viewModel.setBeforeProduct(title);
      },
  ...
  Widget buildProductItems() {
    ...
    int directionsItemCount = viewModel.holdings.length;
    for (var i = 0; i < directionsItemCount; i++) {
      directionsList.add(buildFilterItem(viewModel.holdings[i], 1));
    }
    return Column(
      children: [
        CustomSizedBox(
