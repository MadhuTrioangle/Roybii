...
class CustomCircularProgressIndicator extends StatelessWidget {
  ...
  const CustomCircularProgressIndicator({
    ...
    Key? key,
            ...
            "Number of total steps (totalSteps) of the CustomCircularProgressIndicator must be greater than 0"),
        assert(currentStep >= 0,
            "Current step (currentStep) of the CustomCircularProgressIndicator must be greater than or equal to 0"),
        assert(padding >= 0.0,
            "Padding (padding) of the CustomCircularProgressIndicator must be greater or equal to 0"),
        super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if (arcSize > math.pi * 2)
      print(
          "WARNING (step_progress_indicator): arcSize of CustomCircularProgressIndicator is greater than 360° (math.pi * 2), this will cause some steps to overlap!");
...
/// Used to define the [circularDirection] attribute of the [CustomCircularProgressIndicator]
