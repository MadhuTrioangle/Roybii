...
class _CommonViewState extends State<FundingCoinDetailsView>
              ...
              child: CustomElevatedButton(
                  ...
                  press: () {
                    ...
                    if (item.currencyType == "fiat") {
                      moveToCoinDetailsView(context, item.currencyCode, item.totalAmount.toString(), item.amount.toString(),  item.currencyCode,  item.currencyType,  item.inorder.toString(),item.amount.toString() );
                    } else {
  ...
  Widget buildTopItems() {
    List userFundingWalletDetailsList =
        walletViewModel.userFundingWalletDetails
            .where((element) => element.currencyCode == widget.coin)
            .toList();
    GetUserFundingWalletDetails userFundingWalletDetails;
    ...
    String fiatValue = trimDecimalsForBalance(userFundingWalletDetails.usdValue.toString() == "null" ? "0.00" : userFundingWalletDetails.usdValue.toString());
    String available =
