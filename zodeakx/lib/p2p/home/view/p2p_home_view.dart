...
class _CommonViewState extends State<P2PHomeView>
  ...
  dynamic _showModal(BuildContext context) async {
    ...
    if (result ?? false) {
      ...
      constant.pref?.setString("p2pOnBoarding", entryAddedMap);
    } else {
  ...
  Widget buildHeaderCard(
    ...
    return Align(
        ...
        child: CustomCard(
          ...
          child: CustomContainer(
            width:
                (isSmallScreen(context) ? 2.85 : 2.9) - (currency.length > 3 ? (currency.length - 3) * 0.16 : 0),
            height: 20,
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                  ...
                  child: Theme(
                    ...
                    child: PopupMenuButton(
                      ...
                      constraints: BoxConstraints(
                        minWidth: (size.width * (isSmallScreen(context) ? 0.61 : 0.6)),
                        maxWidth: (size.width * (isSmallScreen(context) ? 0.61 : 0.6)),
...
class CustomDrawerTabState extends State<CustomDrawerTab> {
  ...
  buildListCard(
    ...
    int noOfTrades = advertisement.totalOrders!.toInt();
