...
class _CommonViewState extends State<P2PConfirmPaymentView>
            ...
            CustomSizedBox(
              height:
                  (name == stringVariables.upi || name == stringVariables.paytm)
                      ? isSmallScreen(context) ? 0.14 : 0.125
                      : 0.05,
            ),
            CustomContainer(
              constraints: BoxConstraints(maxWidth: size.width / 1.45),
              child: CustomText(
                strutStyleHeight: 1.3,
                fontfamily: 'GoogleSans',
                text: stringVariables.confirmPaymentContent2,
                fontWeight: FontWeight.w400,
                fontsize: 14,
              ),
            ),
            ...
            Row(
              ...
              children: [
                ...
                CustomContainer(
                  ...
                  child: CustomText(
                    strutStyleHeight: 1.3,
                    text: stringVariables.confirmPaymentContent3,
                    fontfamily: 'GoogleSans',
                    softwrap: true,
                    fontWeight: FontWeight.w400,
                    fontsize: 14,
  ...
  Widget buildPaymentDetails(Size size) {
    ...
    String accNo = name == stringVariables.upi
        ? (payments.paymentDetails?.upiId ?? "")
        : (payments.paymentDetails?.accountNumber ?? "");
    String bankName = payments.paymentDetails?.bankName ?? "";
    String branch = payments.paymentDetails?.branch ?? "";
