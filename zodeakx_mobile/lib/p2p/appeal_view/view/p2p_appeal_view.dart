...
class _CommonViewState extends State<P2PAppealView>
  ...
  Widget buildP2PAppealView(Size size) {
    securedPrint(widget.loggedInUser);
    securedPrint(viewModel.appealId);
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ((viewModel.isNegotiatied ||
                                viewModel.appealHistory?.result?.first
                                        .consensus ==
                                    false))
                            ? SizedBox()
                            : Column(
  ...
  Widget buildOrderDetailsView(Size size) {
    ...
    securedPrint("date${ordersData.createdDate}");
    String createdDate = getDate(
        (ordersData.createdDate ?? DateTime.now().toUtc()).toString(), true);
