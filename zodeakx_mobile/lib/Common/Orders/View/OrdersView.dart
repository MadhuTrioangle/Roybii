...
class _OrdersViewState extends State<OrdersView>
  ...
  Widget buildTabSection(Size size) {
    ...
    securedPrint("viewModel.openLength${openLength}");
                                                                      ...
                                                                      Stack(
                                                                        ...
                                                                        children: [
                                                                          CircularProgressIndicator(
                                                                            value:
                                                                                (viewModel.openOrderHistory![index].partialAmount / viewModel.openOrderHistory![index].total) * 100,
                                                                            backgroundColor:
                                                                                Colors.grey,
                                                                            valueColor:
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                CustomText(overflow: TextOverflow.ellipsis, softwrap: true, text: stringVariables.price, color: hintLight, fontfamily: 'InterTight', fontWeight: FontWeight.w600, fontsize: 13),
                                                                                CustomSizedBox(
                                                                                  width: 0.095,
                                                                                ),
                                                                                CustomText(
                                                                                ...
                                                                                CustomText(overflow: TextOverflow.ellipsis, softwrap: true, text: " ${viewModel.openOrderHistory![index].pair.split('/')[1]}", color: hintLight, fontfamily: 'InterTight', fontWeight: FontWeight.w500, fontsize: 12),
                                                                              ],
                                                                            ),
                                                                            CustomSizedBox(
                                                                              height: 0.005,
                                                                            ...
                                                                            Row(
                                                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                              children: [
                                                                                CustomText(overflow: TextOverflow.ellipsis, softwrap: true, text: stringVariables.total, color: hintLight, fontfamily: 'InterTight', fontWeight: FontWeight.w600, fontsize: 13),
                                                                                CustomSizedBox(
                                                                                  width: 0.1,
                                                                                ),
                                                                                CustomText(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          CustomText(
                                                                            text:
                                                                                trimDecimals((viewModel.cancelOrders![index].partialAmount).toString()),
                                                                            softwrap:
                                                                                true,
                                                                            overflow:
                                                                                TextOverflow.ellipsis,
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          CustomText(
                                                                            text:
                                                                                trimDecimals((viewModel.tradeHistory!.data![index].filledAmount).toString()),
                                                                            softwrap:
                                                                                true,
                                                                            overflow:
                                                                                TextOverflow.ellipsis,
