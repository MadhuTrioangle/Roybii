...
class OrdersViewModel extends ChangeNotifier {
  ...
  setOpenOrders(List<Order>? data) {
    var exchageviewmodel = Provider.of<ExchangeViewModel>(
        NavigationService.navigatorKey.currentContext!,
        listen: false);
    openOrderHistory = data;
    exchageviewmodel.getExchangeSocket();
    setLoading(false);
    notifyListeners();
    ...
    if (hasInternet) {
      ...
      switch (decodeResponse.status?.index) {
        case 0:
          ...
          break;
        case 1:
          (decodeResponse.data!.result!.data == null ||
                  decodeResponse.data!.result!.data!.isEmpty)
