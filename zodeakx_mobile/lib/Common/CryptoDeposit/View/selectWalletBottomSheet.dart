                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  CustomText(
                                    text: type == 1
                                        ? stringVariables.changeNetwork
                                        : stringVariables.changeWallet,
                                      ...
                                      children: [
                                        ...
                                        CustomContainer(
                                          ...
                                          child: ListView.builder(
                                              itemCount: getCurrencyViewModel
                                                  .networkDropDown.length,
                                                ...
                                                return Column(
                                                  children: [
                                                    GestureDetector(
                                                      ...
                                                      onTap: () {
                                                        Navigator.pop(context);
                                                        getCurrencyViewModel.setNetwork(
                                                            getCurrencyViewModel
                                                                    .networkDropDown[
                                                                index]);
                                                        coinDetailsViewModel
                                  ...
                                  : Column(
                                      children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          onTap: () {
                                            viewModel.updateUserDefaultWallet(
                                                stringVariables.spotWallet);
                                            Navigator.pop(context);
                                          },
                                          child: CustomText(
                                            text: stringVariables.spotWallet,
                                            fontsize: 16,
