...
class LoginViewModel extends ChangeNotifier {
  ...
  setLoginUserDetails(LoginModel? loginModel, context) {
    ...
    loginResponse = loginModel?.result;
    notifyListeners();
    if (loginModel?.statusCode == 400) {
      ...
      if (loginResponse?.accountStatus != "Tfa Enable" &&
          loginResponse?.mobileStatus != "verified") {
        ...
        moveToVerifyCode(
            ...
            loginResponse?.mobileStatus,
            loginResponse?.mobileCode,
