...
class CommonRepository {
  ...
  Future<CreateUser> MutatecreateUser(Map<String, dynamic> params) async {
    var createUserResponse = await apiProvider.MutationWithParams(
        commonMutations.createUser, params);
    return CreateUser.fromJson(createUserResponse);
  }

  ///Mutate Create User Bank Details
  Future<AddBankDetails> MutatecreateUserBankDetails(
      Map<String, dynamic> params) async {
    var createUserBankDetailsResponse = await apiProvider.MutationWithParams(
        commonMutations.createUserBankDetails, params);
    return AddBankDetails.fromJson(createUserBankDetailsResponse);
  }

  ///Mutate Create User Edit Bank Details
  Future<EditBankDetails> MutatecreateUserEditBankDetails(
      Map<String, dynamic> params) async {
    var createUserBankDetailsResponse = await apiProvider.MutationWithParams(
        commonMutations.createUserEditBankDetails, params);
    return EditBankDetails.fromJson(createUserBankDetailsResponse);
  }

  ///Mutate Create User Delete Bank Details
  Future<DeleteBankDetail> MutateDeleteBankDetails(
      Map<String, dynamic> params) async {
    var createUserBankDetailsResponse = await apiProvider.MutationWithParams(
        commonMutations.deleteBankDetails, params);
    return DeleteBankDetail.fromJson(createUserBankDetailsResponse);
  }

  /// Mutarte create antiphishing code

  Future<AntiPhishingCode> MutatecreateAntiPhishingCode(
      Map<String, dynamic> params) async {
    var createCode = await apiProvider.MutationWithParams(
        commonMutations.createAntiPhishingCode, params);
    return AntiPhishingCode.fromJson(createCode);
  }

  /// Mutate Create User
  Future<Verifytfa> MutateVerifyTFA(Map<String, dynamic> params) async {
    var verifyTFAResponse =
        await apiProvider.MutationWithParams(commonMutations.verifyTFA, params);
    return Verifytfa.fromJson(verifyTFAResponse);
  }

  /// Mutate Create Forgot Password
  Future<SendForgetPasswordVerifyMail> forgotPassword(
      Map<String, dynamic> params) async {
    var forgotPasswordResponse = await apiProvider.MutationWithParams(
        commonMutations.forgotPassword, params);
    return SendForgetPasswordVerifyMail.fromJson(forgotPasswordResponse);
  }

  ///mutate verify forgot password
  Future<VerifyForgotPasswordModel> verifyForgotPassword(
      Map<String, dynamic> params) async {
    var forgotPasswordResponse = await apiProvider.MutationWithParams(
        commonMutations.verifyForgotPassword, params);
    return VerifyForgotPasswordModel.fromJson(forgotPasswordResponse);
  }

  /// mutate verify Google Authentication Code
  Future<AntiPhishingCodeVerification> verifiedCode(
      Map<String, dynamic> params) async {
    var verifiedResponse = await apiProvider.MutationWithParams(
        commonMutations.verifyAuthentication, params);
    return AntiPhishingCodeVerification.fromJson(verifiedResponse);
  }

  /// mutate get otp
  Future<CommonModel> mutateOtpCodeFromMobile(
      Map<String, dynamic> params) async {
    var verifiedResponse = await apiProvider.MutationWithParams(
        commonMutations.sendMobileOtp, params);
    return CommonModel.fromJson(verifiedResponse);
  }

  /// mutate verifyTfa Code
  Future<VerifyTfaLoginClass> verifyTfaCode(Map<String, dynamic> params) async {
    var verifyTfaCodeResponse = await apiProvider.MutationWithParams(
        commonMutations.verifyTfaLogin, params);
  ...
  Future<NewPasswordClass> createPassword(Map<String, dynamic> params) async {
    var newPasswordResponse = await apiProvider.MutationWithParams(
        commonMutations.newPassword, params);
    return NewPasswordClass.fromJson(newPasswordResponse);
  }

  Future<ResendMail> MutateResendEmail(Map<String, dynamic> params) async {
    var resendEmailResponse = await apiProvider.MutationWithParams(
        commonMutations.resendEmail, params);
    return ResendMail.fromJson(resendEmailResponse);
  }

  /// Mutate Verify Email
  Future<CommonModel> MutateVerifyEmail(Map<String, dynamic> params) async {
    var verifyEmailResponse = await apiProvider.MutationWithParams(
        commonMutations.verifyEmail, params);
  ...
  Future<CommonModel> MutatelogoutUser(Map<String, dynamic> params) async {
    var logoutUserResponse = await apiProvider.MutationWithParams(
        commonMutations.logoutUser, params);
    return CommonModel.fromJson(logoutUserResponse);
  }

  Future<ReactivateAccountModel> MutateReactivateAccount(
      Map<String, dynamic> params) async {
    var reactivateUserResponse = await apiProvider.MutationWithParams(
        commonMutations.reactivateAccount, params);
  ...
  Future<CommonModel> MutateActivateAccount(Map<String, dynamic> params) async {
    var reactivateUserResponse = await apiProvider.MutationWithParams(
        commonMutations.activateAccount, params);
    return CommonModel.fromJson(reactivateUserResponse);
  }

  Future<CommonModel> updateMobileNumber(Map<String, dynamic> params) async {
    var response = await apiProvider.MutationWithParams(
        commonMutations.updateMobileNumber, params);
    return CommonModel.fromJson(response);
  }

  Future<CommonModel> verifyMobileNumber(Map<String, dynamic> params) async {
    var response = await apiProvider.MutationWithParams(
        commonMutations.verifyMobileNumber, params);
    return CommonModel.fromJson(response);
  }

  Future<CommonModel> setDeleteMobileNumber(Map<String, dynamic> params) async {
    var response = await apiProvider.MutationWithParams(
        commonMutations.setDeleteMobileNumber, params);
    return CommonModel.fromJson(response);
  }

  Future<VerifyNewDeviceClass> MutateNewDeviceLogin(
      Map<String, dynamic> params) async {
    var reactivateUserResponse = await apiProvider.MutationWithParams(
        commonMutations.newDeviceLogin, params);
    return VerifyNewDeviceClass.fromJson(reactivateUserResponse);
  }

  /// forgotPasswordVerifyEmail
  Future<CommonModel> MutateForgotPasswordVerifyEmail(
      Map<String, dynamic> params) async {
    var verifyMailResponse = await apiProvider.MutationWithParams(
        commonMutations.verifyForgotPasswordVerifyMail, params);
    return CommonModel.fromJson(verifyMailResponse);
  }

  ///verifyRegisterEmail
  Future<CommonModel> MutateRegisterPasswordVerifyEmail(
      Map<String, dynamic> params) async {
    var verifyRegisterMailResponse = await apiProvider.MutationWithParams(
        commonMutations.verifyRegisterEmail, params);
