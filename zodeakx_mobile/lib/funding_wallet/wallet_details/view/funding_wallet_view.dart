...
class FundingWalletView extends StatefulWidget {
  final UserFundingWalletDetails item;
  FundingWalletView({
    Key? key,
    required this.item,
  }) : super(key: key);
...
class _FundingWalletViewState extends State<FundingWalletView> {
  ...
  late UserFundingWalletDetails items;
  ...
  void initState() {
    ...
    fundingWalletViewModel =
        Provider.of<FundingWalletViewModel>(context, listen: false);
              ...
              children: [
                ...
                Align(
                  ...
                  child: CustomText(
                    ...
                    text:
                        "${constant.walletCurrency.value} ${stringVariables.wallets}",
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              CustomText(
                text: items.currency_type == "crypto"
                    ? trimDecimalsForBalance(items.totalAmount.toString())
                    ...
                    Row(
                      children: [
                        CustomText(
                          ...
                          overflow: TextOverflow.ellipsis,
                          text: items.currency_type == "crypto"
                              ? trimDecimalsForBalance(items.amount.toString())
                    ...
                    Row(
                      children: [
                        CustomText(
                          ...
                          overflow: TextOverflow.ellipsis,
                          text: items.currency_type == "crypto"
                              ? trimDecimalsForBalance(items.inorder.toString())
                ...
                CustomElevatedButton(
                    ...
                    press: () {
                      ...
                      commonWithdrawViewModel.setRadioValue(
                          SelectWallet.funding, items.amount.toString());
                    ...
                    onTap: () {
                      ...
                      CoinDetailsViewModel viewmodel =
                          Provider.of<CoinDetailsViewModel>(context,
                              listen: false);
                      viewmodel.getCryptoCurrency(items.currency_type);
                    },
                    child: SvgPicture.asset(
                      cancel,
                      height: 18,
                    ...
                    CustomIconButton(
                      onPress: () {
                        Clipboard.setData(ClipboardData(
                                text: Provider.of<CoinDetailsViewModel>(context,
                                            listen: false)
                                        .findAddress
                                        ?.address ??
                                    stringVariables.loading))
