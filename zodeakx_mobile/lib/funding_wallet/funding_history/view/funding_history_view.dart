...
class _FundingHistoryViewState extends State<FundingHistoryView>
  ...
  void initState() {
    ...
    payTabController = TabController(length: 2, vsync: this);
                      ...
                      CustomContainer(
                        ...
                        child: TabBar(
                          ...
                          tabs: [
                            ...
                            Tab(
                              text: stringVariables.pay,
                            ),
                          ],
                        ),
                      ),
                      walletTabBarView(size)
                    ],
                  )))),
    );
  }
  ...
  buildPayTabBar() {
    List<Tab> tabs = [];
    viewModel.payTabs.forEach((element) {
      tabs.add(Tab(text: element));
    });
    return tabs;
  }
