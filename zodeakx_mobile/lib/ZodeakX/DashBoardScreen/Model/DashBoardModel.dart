...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        getBalance: json["getBalance"] == null
            ? null
            : GetBalance.fromJson(json["getBalance"]),
      );
...
class GetBalance {
  ...
  factory GetBalance.fromRawJson(String str) =>
  ...
  factory GetBalance.fromJson(Map<String, dynamic> json) => GetBalance(
        ...
        result: json["result"] == null
            ? null
            : List<DashBoardBalance>.from(
                json["result"].map((x) => DashBoardBalance.fromJson(x))),
...
class DashBoardBalance {
  ...
  factory DashBoardBalance.fromRawJson(String str) =>
      DashBoardBalance.fromJson(json.decode(str));
  ...
  factory DashBoardBalance.fromJson(Map<String, dynamic> json) =>
      DashBoardBalance(
        ...
        currencyType: json["currency_type"] == null
            ? null
            : currencyTypeValues.map![json["currency_type"]],
        depositStatus: json["deposit_status"] == null
            ? null
            : statusValues.map![json["deposit_status"]],
        withdrawStatus: json["withdraw_status"] == null
            ? null
            : statusValues.map![json["withdraw_status"]],
        tradeStatus: json["trade_status"] == null
            ? null
            : statusValues.map![json["trade_status"]],
        stakeBalance:
            json["stake_balance"] == null ? null : json["stake_balance"],
        mlmStakeBalance: json["mlm_stakeBalance"]?.toDouble(),
        availableBalance: json["available_balance"] == null
            ? null
            : json["available_balance"],
        inorderBalance:
            json["inorder_balance"] == null ? null : json["inorder_balance"],
        totalBalance:
        ...
        defaultCryptoValue: json["defaultCryptoValue"] == null
            ? null
            : json["defaultCryptoValue"],
        status:
            json["status"] == null ? null : statusValues.map![json["status"]],
        setback_rate:
            json["setback_rate"] == null ? null : json["setback_rate"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "currency_type": currencyType == null
            ? null
            : currencyTypeValues.reverse[currencyType],
        "deposit_status":
            depositStatus == null ? null : statusValues.reverse[depositStatus],
        "withdraw_status": withdrawStatus == null
            ? null
            : statusValues.reverse[withdrawStatus],
        "trade_status":
            tradeStatus == null ? null : statusValues.reverse[tradeStatus],
        ...
        "defaultCryptoValue":
            defaultCryptoValue == null ? null : defaultCryptoValue,
        "status": status == null ? null : statusValues.reverse[status],
        "setback_rate": setback_rate == null ? null : setback_rate,
        "__typename":
...
final currencyTypeValues =
    EnumValues({"crypto": CurrencyType.CRYPTO, "fiat": CurrencyType.FIAT});

enum Status { ACTIVE, IN_ACTIVE }

final statusValues =
    EnumValues({"Active": Status.ACTIVE, "InActive": Status.IN_ACTIVE});

enum Typename { BALANCE_RESPONSE }

final typenameValues =
    EnumValues({"BalanceResponse": Typename.BALANCE_RESPONSE});
...
DashBoardBalance allBusinessPair = DashBoardBalance(currencyCode: "ALL");
